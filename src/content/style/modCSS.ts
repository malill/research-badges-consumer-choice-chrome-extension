// We inject the platform CSS in content script "searchResultsPage.ts".
...
/* --- BADGES --- */
/*Badge1, Highlight (Amazon's Choice)*/
...
// DISPLAY ALL BADGES EXCEPT AMAZON'S CHOICE
export const modCSS_04 = `
/* --- BADGES --- */
/*Badge1, Highlight (Best Seller)*/
span.rush-component [data-component-props*='best-seller'],
/*Badge2 & 3, lightning red, Save X% OR Limited Time Deal*/
