...
/*Badge18, Sub-company, e.g. "morrisons", "amazon-fresh"*/
/*No rule needed, since already hidden by rule "Delivery info" below*/

/*Badge19, "100+ bought in past week"*/
/*No rule needed, since already hidden by badge7 strike price annotation (RDP) */
